#!/usr/bin/env python3
# SECURITY MANIFEST:
# Environment variables accessed: FATSECRET_CONSUMER_KEY, FATSECRET_CONSUMER_SECRET,
#   FATSECRET_ACCESS_TOKEN, FATSECRET_ACCESS_SECRET (only)
# External endpoints called: https://platform.fatsecret.com/rest/server.api (only)
...
Environment variables:
    ...
    FATSECRET_ACCESS_TOKEN    (optional, for delegated calls)
    FATSECRET_ACCESS_SECRET   (optional, for delegated calls)
"""
...
def _build_client() -> Fatsecret:
    ...
    if not consumer_key or not consumer_secret:
        print(
            json.dumps(
                {
                    "error": "FATSECRET_CONSUMER_KEY and FATSECRET_CONSUMER_SECRET must be set."
                }
            ),
            file=sys.stderr,
        )
    ...
    return Fatsecret(consumer_key, consumer_secret, session_token=session_token)
...
def cmd_foods_search(fs, args):
    ...
    _output(fs.foods_search(args.query, **kwargs))
...
def cmd_foods_autocomplete(fs, args):
    ...
    if args.language:
        kwargs["language"] = args.language
    _output(fs.foods_autocomplete(args.expression, **kwargs))


def cmd_food_get(fs, args):
    _output(fs.food_get(args.food_id))
...
def cmd_food_get_v2(fs, args):
    ...
    if args.language:
        kwargs["language"] = args.language
    _output(fs.food_get_v2(args.food_id, **kwargs))
...
def cmd_food_find_id_for_barcode(fs, args):
    ...
    if args.language:
        kwargs["language"] = args.language
    _output(fs.food_find_id_for_barcode(args.barcode, **kwargs))
...
def cmd_food_add_favorite(fs, args):
    ...
    _output(fs.food_add_favorite(args.food_id, **kwargs))
...
def cmd_food_delete_favorite(fs, args):
    ...
    if args.number_of_units is not None:
        kwargs["number_of_units"] = args.number_of_units
    _output(fs.food_delete_favorite(args.food_id, **kwargs))


def cmd_foods_get_favorites(fs, args):
    _output(fs.foods_get_favorites())
...
def cmd_foods_get_most_eaten(fs, args):
    ...
    _output(fs.foods_get_most_eaten(**kwargs))
...
def cmd_foods_get_recently_eaten(fs, args):
    ...
    if args.meal:
        kwargs["meal"] = args.meal
    _output(fs.foods_get_recently_eaten(**kwargs))
...
def cmd_food_entry_edit(fs, args):
    kwargs = {}
    if args.entry_name:
        kwargs["entry_name"] = args.entry_name
    if args.serving_id:
        kwargs["serving_id"] = args.serving_id
    if args.num_units is not None:
        kwargs["num_units"] = args.num_units
    if args.meal:
        kwargs["meal"] = args.meal
    _output(fs.food_entry_edit(args.food_entry_id, **kwargs))


def cmd_food_entry_delete(fs, args):
    _output(fs.food_entry_delete(args.food_entry_id))
...
def cmd_food_entries_get(fs, args):
    ...
    if args.food_entry_id:
        ...
        kwargs["date"] = _parse_date(args.date)
    _output(fs.food_entries_get(**kwargs))
...
def cmd_food_entries_get_month(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.food_entries_get_month(**kwargs))
...
def cmd_food_entries_copy(fs, args):
    ...
    if args.meal:
        kwargs["meal"] = args.meal
    _output(
        fs.food_entries_copy(
            _parse_date(args.from_date), _parse_date(args.to_date), **kwargs
        )
    )
...
def cmd_food_entries_copy_saved_meal(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.food_entries_copy_saved_meal(args.meal_id, args.meal, **kwargs))


def cmd_saved_meal_create(fs, args):
    kwargs = {}
    if args.meal_desc:
        kwargs["meal_desc"] = args.meal_desc
    if args.meals:
        kwargs["meals"] = [m.strip() for m in args.meals.split(",")]
    _output(fs.saved_meal_create(args.meal_name, **kwargs))


def cmd_saved_meal_delete(fs, args):
    _output(fs.saved_meal_delete(args.meal_id))
...
def cmd_saved_meal_edit(fs, args):
    ...
    if args.meals:
        kwargs["meals"] = [m.strip() for m in args.meals.split(",")]
    _output(fs.saved_meal_edit(args.meal_id, **kwargs))
...
def cmd_saved_meal_get(fs, args):
    ...
    if args.meal:
        kwargs["meal"] = args.meal
    _output(fs.saved_meal_get(**kwargs))


def cmd_saved_meal_item_add(fs, args):
    _output(
        fs.saved_meal_item_add(
            args.meal_id,
            args.food_id,
            args.food_entry_name,
            args.serving_id,
...
def cmd_saved_meal_item_delete(fs, args):
    _output(fs.saved_meal_item_delete(args.meal_item_id))


def cmd_saved_meal_item_edit(fs, args):
    kwargs = {}
    if args.item_name:
        kwargs["item_name"] = args.item_name
    if args.num_units is not None:
        kwargs["num_units"] = args.num_units
    _output(fs.saved_meal_item_edit(args.meal_item_id, **kwargs))


def cmd_saved_meal_items_get(fs, args):
    _output(fs.saved_meal_items_get(args.meal_id))
...
def cmd_recipes_search(fs, args):
    ...
    if args.max is not None:
        kwargs["max_results"] = args.max
    _output(fs.recipes_search(args.query, **kwargs))


def cmd_recipe_get(fs, args):
    _output(fs.recipe_get(args.recipe_id))


def cmd_recipe_types_get(fs, args):
    _output(fs.recipe_types_get())


def cmd_recipes_add_favorite(fs, args):
    _output(fs.recipes_add_favorite(args.recipe_id))


def cmd_recipes_delete_favorite(fs, args):
    _output(fs.recipes_delete_favorite(args.recipe_id))


def cmd_recipes_get_favorites(fs, args):
    _output(fs.recipes_get_favorites())


def cmd_exercises_get(fs, args):
    _output(fs.exercises_get())
...
def cmd_exercise_entries_get(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.exercise_entries_get(**kwargs))
...
def cmd_exercise_entries_get_month(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.exercise_entries_get_month(**kwargs))
...
def cmd_exercise_entries_commit_day(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.exercise_entries_commit_day(**kwargs))
...
def cmd_exercise_entries_save_template(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.exercise_entries_save_template(args.days, **kwargs))
...
def cmd_exercise_entry_edit(fs, args):
    ...
    if args.kcals is not None:
        kwargs["kcals"] = args.kcals
    _output(
        fs.exercise_entry_edit(
            args.shift_to_id, args.shift_from_id, args.minutes, **kwargs
        )
    )
...
def cmd_profile_create(fs, args):
    ...
    _output(fs.profile_create(**kwargs))


def cmd_profile_get(fs, args):
    _output(fs.profile_get())


def cmd_profile_get_auth(fs, args):
    _output(fs.profile_get_auth(args.user_id))
...
def cmd_weight_update(fs, args):
    ...
    _output(fs.weight_update(args.current_weight_kg, **kwargs))
...
def cmd_weights_get_month(fs, args):
    ...
    if args.date:
        kwargs["date"] = _parse_date(args.date)
    _output(fs.weights_get_month(**kwargs))
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--entry_name", default=None)
    p.add_argument("--serving_id", default=None)
    p.add_argument("--num_units", type=float, default=None)
    p.add_argument("--meal", default=None, choices=["breakfast", "lunch", "dinner", "other"])
    ...
    p.add_argument("--meal_id", required=True)
    p.add_argument("--meal", required=True, choices=["breakfast", "lunch", "dinner", "other"])
    p.add_argument("--date", default=None)

    # --- Saved meals ---
    p = subs.add_parser("saved_meal_create")
    p.add_argument("--meal_name", required=True)
    p.add_argument("--meal_desc", default=None)
    ...
    p.add_argument("--food_entry_name", required=True)
    p.add_argument("--serving_id", required=True)
    p.add_argument("--num_units", type=float, required=True)

    p = subs.add_parser("saved_meal_item_delete")
    p.add_argument("--meal_item_id", required=True)

    p = subs.add_parser("saved_meal_item_edit")
    p.add_argument("--meal_item_id", required=True)
    p.add_argument("--item_name", default=None)
    p.add_argument("--num_units", type=float, default=None)
    ...
    p.add_argument("--kcals", type=int, default=None)

    # --- Profile ---
    p = subs.add_parser("profile_create")
    p.add_argument("--user_id", default=None)

    subs.add_parser("profile_get")
